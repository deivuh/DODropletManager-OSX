...
***REMOVED***            [shutdownMI setOnStateImage:[NSImage imageNamed:@"power-icon-highlighted"]];
...
***REMOVED***            [turnOnMI setOnStateImage:[NSImage imageNamed:@"power-icon-highlighted"]];
